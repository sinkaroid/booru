...
class Konachan_Net(object):
    ...
    async def search(
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(Booru.konachan_net, params=self.specs) as resp:
                ...
                self.not_random = Konachan_Net.append_object(self.final)
                ...
                try:
                    if gacha:
                        ...
                        return better_object(Konachan_Net.append_object(self.final))
